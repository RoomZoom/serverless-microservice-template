...
variable "kafka_cluster_arn" {
  description = "ARN of your existing MSK cluster for dev"
  type        = string
  # Example: "arn:aws:kafka:us-east-1:123456789012:cluster/my-cluster-dev/uuid"
}

variable "kafka_bootstrap_servers" {
  description = "Bootstrap servers for your MSK cluster"
  type        = string
  # Example: "broker1.dev.cluster.kafka.us-east-1.amazonaws.com:9092,broker2.dev.cluster.kafka.us-east-1.amazonaws.com:9092"
}
